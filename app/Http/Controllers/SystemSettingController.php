...
class SystemSettingController extends Controller
{
    ...
    public function index()
    {
        ...
        $decimal_number_limits = [1, 2, 3, 4, 5];
        ...
        return view('system-setting.index', compact('system_setting','currencies','decimal_number_limits', 'currency_positions', 'date_formats','timezones'));
    }
    ...
    {
        return view('system-setting.create');
    }
    ...
    {
        return view('system-setting.show');
    }
    ...
    {
        return view('system-setting.edit');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if($validator->fails()){
            ...
            if(SystemSetting::find($id)->update($input)){
                return response()->json(['success' => 'System Setting updated successfully done!']);
