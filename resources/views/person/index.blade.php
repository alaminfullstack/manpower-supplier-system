...
@section('breadcrumb')
<h1 class="flex-grow-1 fs-3 fw-bold my-2 my-sm-3">Person</h1>
...
<div class="block block-rounded">
    <div class="block-header border-bottom border-2">
        <h3 class="mb-0 py-1 fs-4 fw-bold">Person List</h3>
        <button  class="btn btn-sm btn-outline-primary show-modal" data-url="{{ route('person.create') }}">Create New Person</button>
...
<script>
        ...
        var table = $('#example').DataTable({
            ...
            },
            {
                ...
                attr:  {
                    url: @json(route('person.multi_delete'))
                }
            }
            ],
        });
