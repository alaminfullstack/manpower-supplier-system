...
@section('breadcrumb')
<h1 class="flex-grow-1 fs-3 fw-bold my-2 my-sm-3">Draft Invoice</h1>
<nav class="flex-shrink-0 my-2 my-sm-0 ms-sm-3" aria-label="breadcrumb">
    <ol class="breadcrumb">
        <li class="breadcrumb-item">Invoice</li>
        <li class="breadcrumb-item active" aria-current="page">Draft Invoice</li>
    </ol>
</nav>
@endsection
...
<div class="block block-rounded">
    <div class="block-header border-bottom border-2">
        <h3 class="mb-0 py-1 fs-4 fw-bold">Draft Invoice List</h3>
