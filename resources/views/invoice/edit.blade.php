...
@section('breadcrumb')
    <h1 class="flex-grow-1 fs-3 fw-bold my-2 my-sm-3">Edit Invoice</h1>
...
@section('content')
    ...
    <div class="block block-rounded">
        <div class="block-header border-bottom border-2">
            <h3 class="mb-0 py-1 fs-4 fw-bold">Edit Invoice</h3>
        </div>
                        ...
                        <div class="row">
                            <div class="col-12 col-md-6 col-lg-4 mb-4">
                                ...
                                <input type="datetime-local" class="form-control" name="invoice_date"
                                    value="{{ $invoice->invoice_date->format('Y-m-d\TH:i:s') }}">
                            </div>

                            <div class="col-12 col-md-6  col-lg-4 mb-4">
                                <label class="form-label">Invoice No</label>
                                <input type="text" class="form-control" value={{ $invoice->invoice_number }} name="invoice_number"
                                   />
                            </div>

                            <div class="col-12 col-md-6 col-lg-4 mb-4">
                                <label class="form-label">Due Date</label>
                                <input type="date" value="{{ $invoice->due_date != null ? $invoice->due_date->format('Y-m-d\TH:i:s') : '' }}" class="form-control" name="due_date"
                                    >
                            </div>
                            ...
                            <div class="col-12 col-md-6 col-lg-4 mb-4">
                                ...
                                <input type="text" class="form-control" value="{{ $invoice->credit_days }}" name="credit_days"
                                    />
                            </div>
                            <div class="col-12 col-md-6 col-lg-4 mb-4">
                                <label class="form-label">Payment Mode</label>
                                <input type="text" value={{ $invoice->payment_mode }} class="form-control" name="payment_mode"
                                    />
                            </div>

                            <div class="col-12 col-md-6 col-lg-4 mb-4">
                                <label class="form-label">Reference No</label>
                                <input type="text" value="{{ $invoice->reference_number }}" class="form-control" name="reference_number"
                                    >
                            </div>

                            <div class="col-12 col-md-6 col-lg-4 mb-4">
                                <label class="form-label">PO Number</label>
                                <input type="text" value="{{ $invoice->po_number }}" class="form-control" name="po_number"
                                    >
                            </div>

                            <div class="col-12 col-md-6 col-lg-4 mb-4">
                                <label class="form-label">Project Number</label>
                                <input type="text" value="{{ $invoice->project_number }}" class="form-control" name="project_number"
                                    >
                            </div>

                            <div class="col-12 col-md-6 col-lg-4 mb-4">
                                <label class="form-label">Subject</label>
                                <input type="text" class="form-control" value="{{ $invoice->subject }}" name="subject"
                                    >
                            </div>
                            ...
                            <div class="col-12 col-md-6 col-lg-4 mb-4">
                                ...
                                <input type="text" class="form-control" value="{{ $payment->iban }}" name="iban"
                                    />
                            </div>

                            <div class="col-12 col-md-6 col-lg-4 mb-4">
                                <label class="form-label">Account Number</label>
                                <input type="text" class="form-control"  value="{{ $payment->account_number }}" name="account_number"
                                    />
                            </div>
                            <div class="col-12 col-md-6 col-lg-8 mb-4">
                                <label class="form-label">Note</label>
                                <input type="text" class="form-control" value="{{ $invoice->note }}" name="note"
                                    />
                            </div>
                        </div>
                    </div>
